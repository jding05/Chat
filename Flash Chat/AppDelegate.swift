...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        //TODO: Initialise and Configure your Firebase here:
            // this part of code get called before anything else
        FirebaseApp.configure()
        
            // we want to save some example data to our brand new firebase database, just to test
            // below is basically a reference to a brand new dtabase within our firebase
//        let myDatabase = Database.database().reference()
            // later, use this database reference to set a nrew value into mydatabase
